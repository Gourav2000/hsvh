                    ...
                    children: [
                      ...
                      Expanded(
                          child: ListView.builder(
                              ...
                              shrinkWrap: true,
                              itemCount: controller.searching.value == 1 ? controller.filteredContact.length : controller.contactName.length,
                              itemBuilder: (context, index){
                                return Padding(
                                  padding: const EdgeInsets.only(left: 15.0, right: 15.0),
                                  child: InkWell(
                                    onTap: () {
                                      Navigator.push(context, MaterialPageRoute(builder: (context) => PersonalConversationPage()));
                                    },
                                    child: Column(
                                            ...
                                            Container(
                                              child: Padding(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Text(
                                                      controller.searching.value == 1
                                                          ?
                                                      controller.filteredContact[index]
                                                          :
                                                      controller.contactName.elementAt(index),
                                                      style: TextStyle(
                                                        fontSize: 20.0,
