...
class RegisterPage extends StatefulWidget {
  ...
  RegisterPage({this.phnNumber,this.email,this.username,this.countryCode,this.countryDialCode});
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                       suffixIcon: Icon(Icons.person),
                        suffix: widget.username!=null?Icon(Icons.check_circle,color: Colors.blue,):null,
                        labelText: 'Username',
                  ...
                  child: Padding(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        suffix: gotEmail!=false?Icon(Icons.check_circle,color: Colors.blue,)
                            :InkWell(
                              onTap: ()async{
                                try{
                                  await AuthServices.instance.updateEmail(email: email);
                                  ...
                                  showDialog(
                                    ...
                                    builder: (ctx) => AlertDialog(
                                      ...
                                      content: Text("A Verrification Email Has been Sent to your email, you need to verrify your email before proceeding"),
                                      actions: <Widget>[
                                        TextButton(
                                          onPressed: () async{
                                           ...
                                           if(FirebaseAuth.instance.currentUser!.emailVerified==true)
                                             ...
                                             showError('Plz verrify ur email in order to proceed', context);
                                           }
                                          },
                                  ...
                                  if (email.length!=0)
                                    showError('User Already registered with this email', context);
                                  else
                                    showError('Enter Valid Email', context);
                                }
                              },
                              child: Container(
                ...
                widget.phnNumber!=null?SizedBox(
                  child: Padding(
                    padding:  EdgeInsets.only(left: width*0.07,right: width *0.07,bottom: height*0.015),
                    child: TextFormField(
                      initialValue: widget.phnNumber??'',
                      readOnly: widget.phnNumber!=null?true:false,
                      ...
                      decoration: InputDecoration(
                        ...
                        prefix: CountryCodePicker(
                          ...
                          enabled: widget.phnNumber!=null?false:true,
                        ...
                        suffix: widget.phnNumber!=null?Icon(Icons.check_circle,color: Colors.blue,) :null,
                    //     InkWell(
                    //       onTap: ()async{
                ...
                widget.phnNumber!=null?SizedBox(height: height*0.05,):SizedBox(),
                SizedBox(
                  child: Padding(
                      ...
                      onTap: () async {
                        if(_formKey.currentState!.validate()){
                          _formKey.currentState!.save();
                            ...
                            await AuthServices.instance.updateName(name: username);
                            if(gotEmail==true)
                              Navigator.push(context, MaterialPageRoute(builder: (context)=>ZeroPage(selectedIndex: 0,)));
                            else
                              showError('Verify your Email before proceeding', context);
                        }
